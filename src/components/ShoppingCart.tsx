      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading && (
          <div className="bg-white rounded-2xl shadow-md p-16 text-center">
            <div className="inline-block w-12 h-12 border-4 border-[#07635d] border-t-transparent rounded-full animate-spin"></div>
        ...
        {!loading && cartItems.length === 0 && (
          <div className="bg-white rounded-2xl shadow-md p-12 sm:p-16 text-center">
            <div className="w-24 h-24 mx-auto mb-6 bg-[#07635d]/5 rounded-full flex items-center justify-center">
              <CartIcon className="w-12 h-12 text-[#07635d]" />
            </div>
                    ...
                    <div className="flex-1 p-6 flex flex-col justify-between">
                      <div>
                        ...
                        <div className="flex items-center gap-4 mb-4">
                          <span className="text-2xl font-black text-[#07635d]">
                      ...
                      <div className="flex items-center justify-between mt-6">
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            onClick={() => updateQuantity(item.id, item.quantity + 1)}
                            className="w-10 h-10 rounded-lg bg-[#07635d] text-white hover:opacity-90 flex items-center justify-center"
                          >
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-2 px-6 py-3 bg-[#07635d] text-white font-bold rounded-xl hover:opacity-90"
                        >
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t-2 border-gray-200 pt-4">
                    <div className="flex justify-between">
                      ...
                      <PriceDisplay price={subtotal} className="text-2xl font-black text-[#07635d]" />
                    </div>
                  </div>
                  <button
                    onClick={proceedToCheckout}
                    className="w-full mt-6 py-4 bg-[#07635d] text-white font-bold rounded-xl hover:opacity-90 transition-colors"
                  >
                    إتمام الطلب
                  </button>
                  <Link
