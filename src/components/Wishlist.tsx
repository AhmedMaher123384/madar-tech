...
const Wishlist: React.FC = () => {
  ...
  const addToCart = async (productId: number, productName: string) => {
    try {
      ...
      // لا تعرض أي توست عند الإضافة للسلة
    } catch (error) {
      // لا تعرض أي توست عند الإضافة للسلة
    }
  };
        ...
        {!loading && wishlistProducts.length === 0 && (
          <div className="bg-white rounded-2xl shadow-md p-12 sm:p-16 text-center">
            <div className="w-24 h-24 mx-auto mb-6 bg-[#07635d]/5 rounded-full flex items-center justify-center">
              <Heart className="w-12 h-12 text-[#07635d]" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/products"
                className="inline-flex items-center justify-center px-8 py-4 bg-[#07635d] text-white font-bold rounded-xl hover:bg-[#4a221f] min-w-[200px]"
              >
                استكشف المنتجات
              </Link>
              <Link
                    ...
                    <div className="flex flex-wrap gap-3 mt-4">
                      ...
                      {product.isAvailable && (
                        <button
                          ...
                          className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#07635d] text-white font-bold rounded-xl hover:bg-[#4a221f]"
                        >
