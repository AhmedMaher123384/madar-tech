...
const AllProducts: React.FC = () => {
 ...
 className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#07635d] focus:border-[#07635d] text-gray-800"
                />
              </div>
            </div>
 ...
 className="w-full px-3 py-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#07635d] focus:border-[#07635d] text-gray-800 bg-white"
              >
 ...
 className={`p-2 rounded-md ${viewMode === 'grid' ? 'text-[#07635d] bg-[#07635d]/10' : 'text-gray-600 hover:text-gray-900'}`}
 ...
 className={`p-2 rounded-md ${viewMode === 'list' ? 'text-[#07635d] bg-[#07635d]/10' : 'text-gray-600 hover:text-gray-900'}`}
 ...
 className="flex items-center gap-2 text-sm text-[#07635d] font-medium hover:text-[#07635d]"
              >
                <X className="w-4 h-4" />
 ...
 <Package className="w-6 h-6 text-[#07635d]" />
            ...
            {(searchTerm || selectedCategory !== null) && (
              <button
                onClick={clearFilters}
 className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#07635d] text-white font-medium rounded-md hover:bg-[#07635d]"
              >
                <X className="w-4 h-4" />
