...
const Checkout: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center" dir="rtl">
        <div className="bg-white rounded-2xl shadow-md p-12 sm:p-16 text-center max-w-md w-full mx-4">
          <div className="w-20 h-20 mx-auto mb-6 bg-[#07635d]/10 rounded-full flex items-center justify-center">
            <ShoppingCart className="w-10 h-10 text-[#07635d]" />
          </div>
          ...
          <button
            ...
            className="inline-flex items-center justify-center px-8 py-4 bg-[#07635d] text-white font-bold rounded-xl hover:opacity-90 min-w-[200px]"
          >
            تسوق الآن
          </button>
        </div>
  ...
  return (
    <section className="min-h-screen bg-gray-50 py-8 sm:py-12" dir="rtl">
      {/* Header */}
      <div className="bg-[#07635d] text-white">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-md p-6">
                      ...
                      <div className="flex-1 min-w-0">
                          ...
                          <div className="mt-2 space-y-1">
                            {item.productOptions.map((opt, idx) => (
                              <div key={idx} className="text-xs text-gray-600">
                                ...
                                {opt.priceModifier > 0 && (
                                  <span className="text-[#07635d] mr-1">
                        ...
                        <div className="mt-3 text-right">
                          <PriceDisplay 
                            ...
                            className="font-black text-[#07635d] text-lg"
                          />
                        </div>
                      </div>
                    </div>
              ...
              <div className="mb-6">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-3 bg-white border border-[#07635d]/30 rounded-lg text-[#07635d] placeholder-[#07635d]/50 focus:outline-none focus:ring-2 focus:ring-[#07635d] text-sm"
                  ...
                  {appliedCoupon ? (
                    ...
                    <button
                      ...
                      className="px-4 py-3 bg-[#07635d] hover:opacity-90 disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed text-white rounded-lg font-bold text-sm"
                    >
              ...
              <div className="space-y-3 border-t border-gray-200 pt-4">
                ...
                <div className="flex justify-between font-black text-[#07635d] text-xl pt-2 border-t border-gray-200">
          ...
          <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#07635d] focus:border-[#07635d] text-gray-800"
                    required
                  />
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#07635d] focus:border-[#07635d] text-gray-800"
                      required
                    />
                  </div>
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={3}
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#07635d] focus:border-[#07635d] text-gray-800 resize-none"
                    required
                  />
                    ...
                    <div
                      ...
                      className={`p-4 border-2 rounded-xl cursor-pointer ${
                        selectedRegion?._id === region._id
                          ? 'border-[#07635d] bg-[#07635d]/5'
                          : 'border-gray-200 hover:border-[#07635d]/40'
                      }`}
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-black text-[#07635d]">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6">
              <button
                ...
                className="w-full bg-[#07635d] hover:opacity-90 disabled:bg-gray-300 disabled:text-gray-500 disabled:cursor-not-allowed text-white font-black py-4 px-6 rounded-xl transition-colors text-lg"
              >
                {placing ? (
