...
const BRAND_PRIMARY = '#07635d';
const BRAND_SECONDARY = '#07635d';
        ...
        <>
          ...
          <div
            ...
            style={{
              ...
              height: '40px',
              borderRadius: '50%',
              background: `linear-gradient(135deg, ${BRAND_SECONDARY}, ${BRAND_PRIMARY})`,
              boxShadow: '0 0 20px rgba(193, 140, 120, 0.35), inset 0 0 20px rgba(255, 255, 255, 0.2)',
          ...
          <div
            ...
            style={{
              ...
              height: '60px',
              borderRadius: '50%',
              border: '1px solid rgba(193, 140, 120, 0.35)',
