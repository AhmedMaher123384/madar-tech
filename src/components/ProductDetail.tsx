...
const FAQCard: React.FC<{ 
 ...
 <div className="bg-[#07635d] text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold flex-shrink-0 mt-1">
            {index + 1}
          </div>
        ...
        <div className="flex-shrink-0 mr-2">
          {isOpen ? (
 <ChevronUp className="w-5 h-5 text-[#07635d]" />
          ) : (
 ...
 <div className="border-r-4 border-[#07635d] pr-4">
...
const ProductDetail: React.FC = () => {
      ...
      <div className="flex gap-1">
        {[1, 2, 3, 4, 5].map((star) => (
          <Star
            key={star}
            className={`w-5 h-5 ${
 star <= rating ? 'text-[#07635d] fill-[#07635d]' : 'text-gray-300'
            }`}
          />
        ))}
      </div>
 ...
 <AlertCircle className="w-6 h-6 text-[#07635d]" />
          </div>
    ...
    <section className="min-h-screen bg-white py-6 sm:py-8" dir={isRTL ? 'rtl' : 'ltr'}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-600 mb-6" dir="ltr">
          <button 
            onClick={() => navigate('/')} 
 className="hover:text-[#07635d] transition-colors"
          >
            {t('home')}
          </button>
 ...
 <div className="h-1 w-24 bg-[#07635d] rounded-full mt-2"></div>
            </div>
 ...
 className="text-2xl font-bold text-[#07635d]"
                  />
                </div>
              ) : (
                <PriceDisplay 
 ...
 <div className={`text-gray-600 ${productOptionsPriceModifier > 0 ? 'text-[#07635d]' : 'text-red-600'}`}>
                          {t('product_options')}: {productOptionsPriceModifier > 0 ? '+' : ''}{formatPrice(productOptionsPriceModifier)}
                        </div>
                      )}
                      {selectedAddOns.length > 0 && (
 <div className="text-[#07635d]">{t('addons')}: +{formatPrice(getAddOnsPrice())}</div>
                      )}
                    </div>
 <div className="text-xl font-bold text-[#07635d]">
 ...
 <Sparkles className="w-5 h-5 text-[#07635d]" />
                  {t('product_options')}
                </h3>
            ...
            {product.addOns && product.addOns.length > 0 && (
              <div className="pt-4">
                <h3 className="text-lg font-bold text-[#0A2A55] mb-3 flex items-center gap-2">
 <Gift className="w-5 h-5 text-[#07635d]" />
                  {t('addons')}
                </h3>
 ...
 isSelected ? 'border-[#07635d] bg-[#07635d]/5' : 'border-gray-200 hover:border-[#07635d]'
                        }`}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3 flex-1">
                            <div className={`w-5 h-5 rounded border flex items-center justify-center ${
 isSelected ? 'border-[#07635d] bg-[#07635d]' : 'border-gray-400'
                            }`}>
 ...
 <div className="text-lg font-bold text-[#07635d]">+{formatPrice(addOn.price)}</div>
                        </div>
                      </div>
                    );
                  })}
            ...
            <div className="pt-4">
              <h3 className="text-lg font-bold text-[#0A2A55] mb-3 flex items-center gap-2">
 <span className="w-5 h-5 bg-[#07635d]/20 rounded flex items-center justify-center text-[#07635d] text-sm">📎</span>
              ...
              <div className="space-y-4">
                <textarea
                  ...
                  rows={2}
 className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#07635d] focus:border-[#07635d]"
                  placeholder={t('notes_placeholder')}
                />
                <div className="flex flex-wrap gap-2">
 <label className="inline-block px-4 py-2 bg-white border border-dashed border-gray-400 rounded-md cursor-pointer hover:border-[#07635d]">
 <span className="text-[#07635d]">📷</span> {t('add_images')}
                    <input
                      type="file"
 ...
 className="flex-1 flex items-center justify-center gap-2 bg-[#07635d] text-white px-6 py-3 rounded-md font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {addingToCart ? (
                    <>
 ...
 className="inline-block px-5 py-2 bg-[#07635d] text-white rounded-md hover:bg-[#07635d]"
                >
                  {t('login')}
                </button>
              </div>
 ...
 <div className="w-10 h-10 bg-[#07635d]/10 rounded-full flex items-center justify-center">
 <User className="w-5 h-5 text-[#07635d]" />
                  </div>
                  <div>
 ...
 className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#07635d] focus:border-[#07635d]"
                    rows={4}
                    maxLength={500}
                  />
 ...
 className="inline-flex items-center gap-2 px-5 py-2 bg-[#07635d] text-white rounded-md disabled:opacity-50"
                >
                  {isSubmittingComment ? (
                    <>
                      <div className="inline-block w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
          ...
          <div className="space-y-4">
            {commentsLoading ? (
              <div className="text-center py-6">
 <div className="inline-block w-6 h-6 border-2 border-[#07635d] border-t-transparent rounded-full animate-spin"></div>
