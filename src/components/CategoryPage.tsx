...
const CategoryPage: React.FC = () => {
  ...
  <select
    ...
    className="px-3 py-2 text-gray-800 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-[#07635d] focus:border-[#07635d]"
  >
    ...
    <option value="price-high">{t('price_high_to_low')}</option>
        ...
        {sortedProducts.length > 0 ? (
          ...
          <div className="text-center py-12 px-4 bg-gray-50 rounded-lg">
            ...
            <Link
              to="/"
 className="inline-flex items-center justify-center px-5 py-2.5 bg-[#07635d] text-white font-medium rounded-md hover:bg-[#07635d] focus:outline-none focus:ring-2 focus:ring-[#07635d]/50 transition-none"
            >
              {t('back_to_home')}
            </Link>
          </div>
