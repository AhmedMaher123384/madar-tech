...
const CheckoutAuthModal: React.FC<CheckoutAuthModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-[9999] flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md mx-auto border border-[#07635d]/20 my-auto" style={{
        maxHeight: '90vh',
        minHeight: 'auto',
        ...
        {/* Header */}
        <div className="p-4 border-b border-[#07635d]/10 bg-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 space-x-reverse">
              <ShoppingCart className="w-5 h-5 text-[#07635d]" />
              <h2 className="text-lg font-bold text-[#07635d]">{t('checkout.completeOrder')}</h2>
            </div>
            <button
              onClick={onClose}
              className="p-1 hover:bg-[#07635d]/10 rounded-full transition-colors"
            >
              <X className="w-4 h-4 text-gray-500 hover:text-[#07635d]" />
            </button>
          </div>
        </div>
        ...
        {!showLoginForm && !showRegisterForm && (
          <div className="p-4 bg-white">
            <div className="text-center mb-4">
              <h3 className="text-base font-semibold text-[#07635d] mb-1">
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full p-3 border border-[#07635d]/40 hover:border-[#07635d] rounded-lg bg-white hover:bg-[#07635d]/5 transition-all group"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2 space-x-reverse">
                    <div className="w-8 h-8 bg-[#07635d]/15 rounded-lg flex items-center justify-center">
                      <User className="w-4 h-4 text-[#07635d]" />
                    </div>
                    <div className="text-right">
                      <h4 className="font-semibold text-[#07635d] text-sm">{t('checkout.continueAsGuest')}</h4>
                <p className="text-xs text-gray-700">{t('checkout.quickMethod')}</p>
                    </div>
                  </div>
                  <ArrowLeft className="w-4 h-4 text-[#07635d] group-hover:translate-x-0.5 transition-transform" />
                </div>
              </button>
              ...
              <button
                ...
                className="w-full p-3 border border-[#07635d]/20 hover:border-[#07635d] rounded-lg bg-white hover:bg-[#07635d]/5 transition-all group"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2 space-x-reverse">
                    <div className="w-8 h-8 bg-[#07635d]/15 rounded-lg flex items-center justify-center">
                      <Shield className="w-4 h-4 text-[#07635d]" />
                    </div>
                    <div className="text-right">
                      <h4 className="font-semibold text-[#07635d] text-sm">{t('auth.login')}</h4>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2 space-x-reverse">
                    <div className="w-8 h-8 bg-[#07635d]/15 rounded-lg flex items-center justify-center">
                      <UserPlus className="w-4 h-4 text-[#07635d]" />
                    </div>
                    <div className="text-right">
                      <h4 className="font-semibold text-[#07635d] text-sm">{t('auth.newAccount')}</h4>
            ...
            {/* Benefits */}
            <div className="mt-4 p-3 bg-white rounded-lg border border-[#07635d]/10">
              <h5 className="font-semibold text-[#07635d] mb-2 text-xs">{t('checkout.accountFeatures')}:</h5>
              <div className="space-y-1">
                <div className="flex items-center space-x-1.5 space-x-reverse text-xs text-gray-700">
                  <Clock className="w-3 h-3 text-[#07635d]" />
                  <span>{t('checkout.orderTracking')}</span>
                </div>
                <div className="flex items-center space-x-1.5 space-x-reverse text-xs text-gray-700">
                  <Star className="w-3 h-3 text-[#07635d]" />
                  <span>{t('checkout.favoriteProducts')}</span>
                </div>
                <div className="flex items-center space-x-1.5 space-x-reverse text-xs text-gray-700">
                  <Shield className="w-3 h-3 text-[#07635d]" />
        ...
        {showLoginForm && (
          <div className="p-4 bg-white">
            <button
              onClick={resetToMain}
              className="flex items-center space-x-1 space-x-reverse text-gray-600 hover:text-[#07635d] mb-3"
            >
              <ArrowLeft className="w-3 h-3 rotate-180" />
              <span className="text-xs">{t('common.back')}</span>
            </button>
            <h3 className="text-base font-semibold text-[#07635d] mb-3">{t('auth.login')}</h3>
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 bg-white border text-gray-900 rounded-lg focus:ring-2 focus:ring-[#07635d] focus:border-[#07635d] text-sm ${
              ...
              <button
                onClick={handleLogin}
                disabled={loading}
                className="w-full bg-[#07635d] hover:bg-[#07635d] disabled:bg-gray-300 text-white py-2.5 rounded-lg font-medium transition-colors text-sm"
              >
        ...
        {showRegisterForm && (
          <div className="p-4 bg-white">
            ...
            <h3 className="text-base font-semibold text-[#07635d] mb-3">{t('auth.createNewAccount')}</h3>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-2 py-2 bg-white border text-gray-900 rounded-lg focus:ring-2 focus:ring-[#07635d] focus:border-[#07635d] text-sm ${
              ...
              <div>
                ...
                <div className="flex">
                  ...
                  <input
                    ...
                    className={`flex-1 px-2 py-2 bg-white border text-gray-900 rounded-l-lg focus:ring-2 focus:ring-[#07635d] focus:border-[#07635d] text-sm ${
