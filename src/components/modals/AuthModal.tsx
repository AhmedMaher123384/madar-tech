...
const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose, onLoginSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 md:p-4 bg-black/70 backdrop-blur-sm" dir="rtl">
      {/* Modal */}
      <div className="relative bg-[#292929] rounded-2xl md:rounded-3xl shadow-2xl w-full max-w-xs md:max-w-md mx-auto overflow-hidden transform transition-all duration-500 border border-[#07635d]/30 hover:border-[#07635d]/50 hover:shadow-[0_0_20px_rgba(193,140,120,0.35)]">
        {/* Animated Background Pattern */}
        <div className="absolute inset-0 opacity-5">
          <div className="absolute inset-0 bg-gradient-to-br from-white via-transparent to-[#07635d]"></div>
          <div className="absolute inset-0" style={{
            backgroundImage: `radial-gradient(circle at 25% 25%, #07635d 0%, transparent 50%), 
                             radial-gradient(circle at 75% 75%, #07635d 0%, transparent 50%)`,
        ...
        <style>
          {`
            ...
            @keyframes glow {
              0%, 100% { filter: drop-shadow(0 0 5px rgba(193, 140, 120, 0.3)); transform: scale(1); }
              50% { filter: drop-shadow(0 0 10px rgba(193, 140, 120, 0.6)); transform: scale(1.05); }
            }
            @keyframes shimmer {
        ...
        {/* Header */}
        <div className="relative bg-gradient-to-r from-[#07635d] to-[#07635d]/20 p-4 md:p-6 text-center">
          <button
            onClick={onClose}
          ...
          <div className="relative w-12 h-12 md:w-16 md:h-16 mx-auto mb-3 md:mb-4">
            <div className="absolute -inset-2 bg-gradient-to-br from-white/30 to-[#07635d]/30 blur-sm transition-all duration-500" style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}></div>
            <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-[#07635d]/15 backdrop-blur-md border border-[#07635d]/30 transition-all duration-500" style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}></div>
        ...
        <div className="p-3 md:p-6 space-y-3 md:space-y-6 relative z-10">
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <Mail className="absolute right-2 md:right-3 top-1/2 transform -translate-y-1/2 text-[#07635d] w-4 h-4 md:w-5 md:h-5" />
                  <input
                    type="email"
                    value={userData.email}
                    onChange={(e) => setUserData({ ...userData, email: e.target.value })}
                    className={`w-full pr-8 md:pr-12 pl-3 md:pl-4 py-2 md:py-3 bg-white/5 backdrop-blur-md border rounded-lg md:rounded-xl focus:outline-none focus:ring-2 focus:ring-[#07635d] transition-all text-white placeholder-gray-400 text-sm md:text-base ${
                      errors.email ? 'border-red-500' : 'border-[#07635d]/30'
                    }`}
              ...
              <div>
                ...
                <div className="relative">
                  <Lock className="absolute right-2 md:right-3 top-1/2 transform -translate-y-1/2 text-[#07635d] w-4 h-4 md:w-5 md:h-5" />
                  <input
                    type={showPassword ? 'text' : 'password'}
                    value={userData.password}
                    onChange={(e) => setUserData({ ...userData, password: e.target.value })}
                    className={`w-full pr-8 md:pr-12 pl-8 md:pl-12 py-2 md:py-3 bg-white/5 backdrop-blur-md border rounded-lg md:rounded-xl focus:outline-none focus:ring-2 focus:ring-[#07635d] transition-all text-white placeholder-gray-400 text-sm md:text-base ${
                      errors.password ? 'border-red-500' : 'border-[#07635d]/30'
                    }`}
                  ...
                  <button
                    ...
                    className="absolute left-2 md:left-3 top-1/2 transform -translate-y-1/2 text-[#07635d] hover:text-[#07635d]"
                  >
              ...
              <button
                ...
                onClick={handleLogin}
                disabled={loading}
                className="w-full bg-gradient-to-r from-[#07635d] to-[#07635d] text-white py-2.5 md:py-4 rounded-xl md:rounded-2xl font-black text-sm md:text-lg hover:from-[#07635d] hover:to-[#07635d] disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 transform flex items-center justify-center gap-1 md:gap-2"
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                <div>
                  ...
                  <div className="relative">
                    <User className="absolute right-2 md:right-3 top-1/2 transform -translate-y-1/2 text-[#07635d] w-4 h-4 md:w-5 md:h-5" />
                    <input
                      type="text"
                      value={userData.firstName}
                      onChange={(e) => setUserData({ ...userData, firstName: e.target.value })}
                      className={`w-full pr-8 md:pr-12 pl-3 md:pl-4 py-2 md:py-3 bg-white/5 backdrop-blur-md border rounded-lg md:rounded-xl focus:outline-none focus:ring-2 focus:ring-[#07635d] transition-all text-white placeholder-gray-400 text-sm md:text-base ${
                        errors.firstName ? 'border-red-500' : 'border-[#07635d]/30'
                      }`}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pr-8 md:pr-12 pl-3 md:pl-4 py-2 md:py-3 bg-white/5 backdrop-blur-md border rounded-lg md:rounded-xl focus:outline-none focus:ring-2 focus:ring-[#07635d] transition-all text-white placeholder-gray-400 text-sm md:text-base ${
                        errors.lastName ? 'border-red-500' : 'border-[#07635d]/30'
                      }`}
              ...
              <div>
                ...
                <div className="relative">
                  <Phone className="absolute right-2 md:right-3 top-1/2 transform -translate-y-1/2 text-[#07635d] w-4 h-4 md:w-5 md:h-5" />
                  <input
                    type="tel"
                    value={formatSaudiPhone(userData.phone)}
                    onChange={(e) => setUserData({ ...userData, phone: e.target.value })}
                    className={`w-full pr-8 md:pr-12 pl-3 md:pl-4 py-2 md:py-3 bg-white/5 backdrop-blur-md border rounded-lg md:rounded-xl focus:outline-none focus:ring-2 focus:ring-[#07635d] transition-all text-white placeholder-gray-400 text-sm md:text-base ${
                      errors.phone ? 'border-red-500' : 'border-[#07635d]/30'
                    }`}
          ...
          <div className="mt-4 md:mt-6 text-center">
            <button
              ...
              className="text-[#07635d] hover:text-[#07635d] font-bold transition-colors text-sm md:text-base"
              disabled={loading}
            >
