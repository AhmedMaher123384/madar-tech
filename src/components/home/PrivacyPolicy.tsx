...
const PrivacyPolicy: React.FC = () => {
 ...
 <div className="absolute top-10 left-10 w-40 h-40 bg-[#07635d]/10 rounded-full blur-3xl animate-pulse"></div>
 <div className="absolute bottom-20 right-20 w-48 h-48 bg-[#07635d]/10 rounded-full blur-3xl animate-pulse animate-pulse-delay-1"></div>
 <div className="absolute top-1/2 left-1/4 w-32 h-32 bg-[#07635d]/10 rounded-full blur-3xl animate-pulse animate-pulse-delay-05"></div>
      </div>
 ...
 <div className="absolute -inset-2 bg-gradient-to-br from-[#07635d]/30 to-[#07635d]/20 blur-sm transform rotate-0 transition-all duration-500 group-hover:scale-110 animate-glow"
                   style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
              </div>
 <div className="absolute inset-0 bg-gradient-to-br from-[#07635d]/20 to-[#07635d]/20 backdrop-blur-md border border-[#07635d]/30 transform rotate-0 transition-all duration-500 group-hover:scale-110"
                   style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
              </div>
              <div className="absolute inset-0 flex items-center justify-center">
 <Shield className="w-6 h-6 sm:w-8 sm:h-8 text-[#07635d] filter drop-shadow-[0_0_12px_rgba(193,140,120,0.6)]" />
              </div>
            </div>
 ...
 <div className="absolute -inset-2 bg-gradient-to-br from-[#07635d]/20 to-[#07635d]/30 blur-sm transform rotate-0 transition-all duration-500 group-hover:scale-110 animate-glow"
                   style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
              </div>
 <div className="absolute inset-0 bg-gradient-to-br from-[#07635d]/20 to-[#07635d]/20 backdrop-blur-md border border-[#07635d]/30 transform rotate-0 transition-all duration-500 group-hover:scale-110"
                   style={{ clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)' }}>
 ...
 <div className="bg-white rounded-xl sm:rounded-2xl border border-[#07635d]/20 p-3 sm:p-4 max-w-xs sm:max-w-2xl mx-auto animate-slideInRight mobile-padding ultra-mobile-padding shadow-sm">
            <div className="flex items-center gap-2 justify-center flex-wrap">
 <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-[#07635d]" />
 ...
 <div className="bg-white rounded-2xl sm:rounded-3xl border border-[#07635d]/15 shadow-xl p-4 sm:p-6 lg:p-8 xl:p-12 mobile-padding ultra-mobile-padding">
            {/* Introduction */}
            <div className="mb-6 sm:mb-8 lg:mb-12 animate-fadeInUp">
 <div className="bg-[#07635d]/5 rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 mobile-padding ultra-mobile-padding hover-lift">
 ...
 <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#07635d] mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3 mobile-text-responsive ultra-mobile-text">
 <FileText className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-[#07635d] flex-shrink-0" />
              ...
              <div className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <div
                    key={item.key}
 className="bg-[#07635d]/5 p-3 sm:p-4 rounded-lg sm:rounded-xl hover:bg-[#07635d]/10 transition-all duration-300 animate-slideInRight mobile-padding ultra-mobile-padding hover-lift"
            ...
            <div className="mb-6 sm:mb-8 lg:mb-10 animate-fadeInUp">
 <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#07635d] mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3 mobile-text-responsive ultra-mobile-text">
 <CheckCircle className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-[#07635d] flex-shrink-0" />
              ...
              <div className="space-y-3 sm:space-y-4">
                {[
                  ...
                  <div
                    key={index}
 className="bg-[#07635d]/5 p-3 sm:p-4 rounded-lg sm:rounded-xl hover:bg-[#07635d]/10 transition-all duration-300 animate-scaleIn mobile-padding ultra-mobile-padding hover-lift"
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
            ...
            <div className="mb-6 sm:mb-8 lg:mb-10 animate-fadeInUp">
 <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#07635d] mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3 mobile-text-responsive ultra-mobile-text">
 <User className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-[#07635d] flex-shrink-0" />
                {t('privacy_policy.data_collection_title')}
              </h2>
              <div className="mb-4 sm:mb-6">
 <h3 className="text-lg sm:text-xl font-bold text-[#07635d] mb-3 sm:mb-4">{t('privacy_policy.data_collection.subtitle')}</h3>
 ...
 className="bg-[#07635d]/5 p-3 sm:p-4 rounded-lg sm:rounded-xl hover:bg-[#07635d]/10 transition-all duration-300 animate-slideInRight mobile-padding ultra-mobile-padding hover-lift"
              ...
              <div className="mb-4 sm:mb-6">
 <h3 className="text-lg sm:text-xl font-bold text-[#07635d] mb-3 sm:mb-4">{t('privacy_policy.data_usage.subtitle')}</h3>
                <div className="space-y-2 sm:space-y-3">
                  {[
                    ...
                    <div
                      key={index}
 className="flex items-center gap-2 sm:gap-3 bg-[#07635d]/5 p-3 sm:p-4 rounded-lg sm:rounded-xl hover:bg-[#07635d]/10 transition-all duration-300 animate-scaleIn mobile-padding ultra-mobile-padding hover-lift"
                      style={{ animationDelay: `${index * 0.1}s` }}
                    >
 <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#07635d] flex-shrink-0" />
                      <span className="text-[#1a1a1a] text-sm sm:text-base">{item}</span>
                    </div>
                  ))}
                </div>
              </div>
 <div className="bg-[#07635d]/5 border border-[#07635d]/10 rounded-lg sm:rounded-xl p-3 sm:p-4 animate-fadeInUp mobile-padding ultra-mobile-padding hover-lift">
            ...
            <div className="mb-6 sm:mb-8 lg:mb-10 animate-fadeInUp">
 <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#07635d] mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3 mobile-text-responsive ultra-mobile-text">
 <AlertCircle className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-[#07635d] flex-shrink-0" />
 ...
 className="bg-[#07635d]/5 p-3 sm:p-4 rounded-lg sm:rounded-xl hover:bg-[#07635d]/10 transition-all duration-300 animate-slideInRight mobile-padding ultra-mobile-padding hover-lift"
            ...
            <div className="mb-6 sm:mb-8 lg:mb-10 animate-fadeInUp">
 <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#07635d] mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3 mobile-text-responsive ultra-mobile-text">
 <Lock className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-[#07635d] flex-shrink-0" />
              ...
              <div className="space-y-2 sm:space-y-3">
                {[
                  ...
                  t('privacy_policy.data_protection.access_control'),
                    ...
                    <div
                      key={index}
 className="flex items-center gap-2 sm:gap-3 bg-[#07635d]/5 p-3 sm:p-4 rounded-lg sm:rounded-xl hover:bg-[#07635d]/10 transition-all duration-300 animate-fadeInUp mobile-padding ultra-mobile-padding hover-lift"
                      style={{ animationDelay: `${index * 0.1}s` }}
                    >
 <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-[#07635d] flex-shrink-0" />
                      <span className="text-[#1a1a1a] text-sm sm:text-base">{item}</span>
                    </div>
                ))}
              </div>
 ...
 <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#07635d] mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3 mobile-text-responsive ultra-mobile-text">
              ...
              <div className="space-y-2 sm:space-y-3">
                {[
                  ...
                  t('privacy_policy.terms_of_use.account_suspension'),
                    ...
                    <div
                      key={index}
                      className="bg-[#07635d]/5 p-3 sm:p-4 rounded-lg sm:rounded-xl hover:bg-[#07635d]/10 transition-all duration-300 animate-fadeInUp mobile-padding ultra-mobile-padding hover-lift"
                      style={{ animationDelay: `${index * 0.1}s` }}
                    >
                      <span className="text-[#1a1a1a] text-sm sm:text-base">{item}</span>
                    </div>
            ...
            <div className="mb-6 sm:mb-8 lg:mb-10 animate-fadeInUp">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#07635d] mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3 mobile-text-responsive ultra-mobile-text">
                <Shield className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-[#07635d] flex-shrink-0" />
            ...
            <div className="mb-6 sm:mb-8 lg:mb-10 animate-fadeInUp">
              ...
              <div className="bg-[#07635d]/5 p-4 sm:p-6 rounded-lg sm:rounded-xl animate-fadeInUp mobile-padding ultra-mobile-padding hover-lift">
            ...
            <div className="mb-6 sm:mb-8 animate-fadeInUp">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#07635d] mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3 mobile-text-responsive ultra-mobile-text">
                <Mail className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-[#07635d] flex-shrink-0" />
            ...
            <div className="text-center animate-fadeInUp">
              <Link
                to="/"
                className="inline-flex items-center gap-2 sm:gap-3 bg-[#07635d] text-white px-4 sm:px-6 lg:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl hover:bg-[#6b332f] transition-all duration-300 transform hover:scale-105 font-bold shadow-lg text-sm sm:text-base hover-lift"
              >
