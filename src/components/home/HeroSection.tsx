...
import heroImage from '../../assets/heroro.png';
...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      {/* طبقة ضوء ديناميكي */}
 <div className="absolute inset-0 bg-gradient-to-t from-transparent via-[#07635d]/5 to-transparent"></div>
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center w-full text-center px-8 space-y-5">
        ...
        <div className="relative group">
          ...
          {/* الهالة الخارجية */}
 <div className="absolute inset-0 rounded-2xl bg-[#07635d] opacity-0 group-hover:opacity-30 blur-xl scale-75 group-hover:scale-125 transition-all duration-700 -z-30"></div>
        </div>

        {/* نقاط ديكور */}
 <div className="absolute top-1/4 left-10 w-2 h-2 bg-[#07635d]/60 rounded-full animate-pulse"></div>
        <div className="absolute top-1/3 right-16 w-1 h-1 bg-white/40 rounded-full animate-pulse delay-300"></div>
 <div className="absolute bottom-1/4 left-20 w-1.5 h-1.5 bg-[#07635d]/40 rounded-full animate-pulse delay-700"></div>
