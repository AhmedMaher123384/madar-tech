...
const TermsAndConditions: React.FC = () => {
  ...
  const renderDefinitionItem = useCallback((item: { label: string; text: string }, index: number) => (
    <div
      key={index}
 className="bg-[#07635d]/5 p-3 sm:p-4 rounded-lg sm:rounded-xl border border-[#07635d]/10 hover:bg-[#07635d]/10 transition-all duration-300 animate-slideInRight mobile-padding ultra-mobile-padding"
      style={{ animationDelay: `${index * 0.1}s` }}
    >
      <div className="flex flex-col sm:flex-row gap-1 sm:gap-2">
 <span className="font-bold text-[#07635d] text-sm sm:text-base flex-shrink-0">{item.label}</span>
  ...
  const renderSimpleItem = useCallback((item: string, index: number, animationClass: string = 'animate-scaleIn') => (
    <div
      key={index}
 className={`bg-[#07635d]/5 p-3 sm:p-4 rounded-lg sm:rounded-xl border border-[#07635d]/10 hover:bg-[#07635d]/10 transition-all duration-300 ${animationClass} mobile-padding ultra-mobile-padding`}
      style={{ animationDelay: `${index * 0.1}s` }}
    >
  ...
  const renderListItem = useCallback((item: string, index: number) => (
    <div
      key={index}
 className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 bg-[#07635d]/5 p-3 sm:p-4 rounded-lg sm:rounded-xl border border-[#07635d]/10 hover:bg-[#07635d]/10 transition-all duration-300 animate-slideInRight mobile-padding ultra-mobile-padding"
      style={{ animationDelay: `${index * 0.1}s` }}
    >
 <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#07635d] flex-shrink-0" />
  ...
  const renderListItemWithAnimation = useCallback((item: string, index: number, animationClass: string) => (
    <div
      key={index}
 className={`flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 bg-[#07635d]/5 p-3 sm:p-4 rounded-lg sm:rounded-xl border border-[#07635d]/10 hover:bg-[#07635d]/10 transition-all duration-300 ${animationClass} mobile-padding ultra-mobile-padding`}
      style={{ animationDelay: `${index * 0.1}s` }}
    >
 <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#07635d] flex-shrink-0" />
      <span className="text-[#1a1a1a] text-sm sm:text-base leading-relaxed">{item}</span>
 ...
 <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#07635d]/10 rounded-full blur-3xl animate-pulse"></div>
 <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-[#07635d]/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
 <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-[#07635d]/10 to-[#07635d]/5 rounded-full blur-3xl animate-float"></div>
      </div>

      {/* Floating Elements */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
 <div className="absolute top-20 left-10 w-2 h-2 bg-[#07635d] rounded-full animate-float" style={{ animationDelay: '0s' }}></div>
 <div className="absolute top-40 right-20 w-3 h-3 bg-[#07635d] rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
 <div className="absolute bottom-40 left-20 w-2 h-2 bg-[#07635d] rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
 <div className="absolute bottom-20 right-10 w-3 h-3 bg-[#07635d] rounded-full animate-float" style={{ animationDelay: '3s' }}></div>
      </div>
 ...
 <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-[#07635d] mb-4 sm:mb-6 mobile-text-responsive ultra-mobile-text">
 ...
 <Calendar className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-[#07635d]" />
 ...
 <Lock className="w-5 h-5 sm:w-6 sm:h-6 lg:w-7 lg:h-7 text-[#07635d] flex-shrink-0" />
              ...
              <div className="space-y-3">
                {limitationLiabilityData.map((item, index) => (
                  <div
                    key={index}
 className="flex items-center gap-3 bg-[#07635d]/5 p-4 rounded-xl border border-[#07635d]/10 hover:bg-[#07635d]/10 transition-all duration-300 animate-fadeInUp"
                    style={{ animationDelay: `${index * 0.1}s` }}
                  >
 <CheckCircle className="w-5 h-5 text-[#07635d]" />
 ...
 <div className="bg-[#07635d]/5 p-4 sm:p-6 rounded-xl border border-[#07635d]/10 animate-fadeInUp mobile-padding ultra-mobile-padding">
 ...
 <div className="bg-[#07635d]/5 border border-[#07635d]/10 rounded-xl sm:rounded-2xl p-4 sm:p-6 animate-scaleIn mobile-padding ultra-mobile-padding">
            ...
            <div className="text-center animate-fadeInUp">
              <Link
                to="/"
 className="inline-flex items-center gap-2 sm:gap-3 bg-[#07635d] text-white px-4 sm:px-6 lg:px-8 py-3 sm:py-4 rounded-lg sm:rounded-xl hover:bg-[#07635d] transition-all duration-300 transform hover:scale-105 font-bold shadow-lg text-sm sm:text-base"
              >
