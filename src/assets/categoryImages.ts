...
const autoAssetsCategories = import.meta.glob('./categories/*.{png,jpg,jpeg,webp,svg,gif,avif}', { eager: true, import: 'default' }) as Record<string, string>;
const autoAssetsRoot = import.meta.glob('./*.{png,jpg,jpeg,webp,svg,gif,avif}', { eager: true, import: 'default' }) as Record<string, string>;
